...
public class NewHeartGenerator : MonoBehaviour
{
    [Serializable]
    ...
    void Update()
    {
        ...
        if (totaltime >= 31 && totaltime <= 31.5f && enemyCount <= 0)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 53 && totaltime <= 53.5f && enemyCount <= 1)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 76 && totaltime <= 76.5f && enemyCount <= 2)
        {
            SpawnEnemy();
        }
    }

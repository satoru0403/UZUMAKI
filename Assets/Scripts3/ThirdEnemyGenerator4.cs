...
public class ThirdEnemyGenerator4 : MonoBehaviour
{
    [Serializable]
    ...
    void Update()
    {
        ...
        if (totaltime >= 4 && totaltime <= 4.5f && enemyCount <= 0)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 21 && totaltime <= 21.5f && enemyCount <= 4)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 23 && totaltime <= 23.5f && enemyCount <= 5)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 37 && totaltime <= 37.5f && enemyCount <= 9)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 42 && totaltime <= 42.5f && enemyCount <= 10)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 45 && totaltime <= 45.5f && enemyCount <= 11)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 48 && totaltime <= 48.5f && enemyCount <= 12)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 53 && totaltime <= 53.5f && enemyCount <= 13)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 54 && totaltime <= 54.5f && enemyCount <= 14)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 63 && totaltime <= 63.5f && enemyCount <= 16)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 74 && totaltime <= 74.5f && enemyCount <= 19)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 77 && totaltime <= 77.5f && enemyCount <= 20)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 82 && totaltime <= 82.5f && enemyCount <= 21)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 97 && totaltime <= 97.5f && enemyCount <= 24)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 101 && totaltime <= 101.5f && enemyCount <= 25)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 105 && totaltime <= 105.5f && enemyCount <= 26)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 113 && totaltime <= 113.5f && enemyCount <= 28)
        {
            SpawnEnemy();
        }
    }

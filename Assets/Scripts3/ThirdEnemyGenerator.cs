...
public class ThirdEnemyGenerator : MonoBehaviour
{
    [Serializable]
    ...
    void Update()
    {
        ...
        else if (totaltime >= 28 && totaltime <= 28.5f && enemyCount <= 6)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 36 && totaltime <= 36.5f && enemyCount <= 8)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 47 && totaltime <= 47.5f && enemyCount <= 12)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 64 && totaltime <= 64.5f && enemyCount <= 17)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 66 && totaltime <= 66.5f && enemyCount <= 18)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 71 && totaltime <= 71.5f && enemyCount <= 19)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 76 && totaltime <= 76.5f && enemyCount <= 21)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 80 && totaltime <= 80.5f && enemyCount <= 22)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 82 && totaltime <= 82.5f && enemyCount <= 23)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 90 && totaltime <= 90.5f && enemyCount <= 24)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 94 && totaltime <= 94.5f && enemyCount <= 25)
        {
            SpawnEnemy();
        }
        ...
        else if (totaltime >= 112 && totaltime <= 112.5f && enemyCount <= 28)
        {
            SpawnEnemy();
        }
        else if (totaltime >= 115 && totaltime <= 115.5f && enemyCount <= 29)
        {
            SpawnEnemy();
        }
    }
